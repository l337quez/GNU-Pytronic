...
Boton_calcular=Button(ventana, text= "Calculate", command= calculo_cap).place(x=420, y=130)
...
label_tc=Label(ventana, text="Calculator of sensor output according to the coil:").place(x=10, y=74)
label_voltaje=Label(ventana, text="Number of turns").place(x=140, y=110)
label_tole=Label(ventana, text="Magnetic Field").place(x=280, y=110)
