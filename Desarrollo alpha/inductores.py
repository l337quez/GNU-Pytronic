...
def calculo_ind( banda1,banda2,banda3,banda4,banda5):
    # ~ banda1=main.ban1_combo.get()
    # ~ banda2=main.ban2_combo.get()
    # ~ banda3=main.ban3_combo.get()
    # ~ banda4=main.ban4_combo.get()
    # ~ banda5=main.ban5_combo.get()
